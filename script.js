...
function updateHotspotVisibility() {
    ...
    document.querySelectorAll(".hotspot").forEach(hotspot => {
        ...
        // Custom quest hotspots only on map2
    ...
    // Floating nav - show on all maps
    const floatingNav = document.getElementById("floating-nav");
    if (floatingNav) {
        floatingNav.style.display = "flex";
    }
    
    // Add custom quest hotspots on map2 if needed
    if (currentMap === 'map2') {
...
async function addCustomQuestHotspots() {
    ...
    try {
        ...
        const customPositions = [
            { top: "71.8%", left: "23.2%" },   // Position 1
            { top: "71%", left: "5%" },   // Position 2
            { top: "83.5%", left: "22.6%" },   // Position 3
            { top: "88.3%", left: "10%" },   // Position 4
            { top: "93.8%", left: "26%" }    // Position 5
        ];
